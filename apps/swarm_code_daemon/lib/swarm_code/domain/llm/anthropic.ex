defmodule SwarmCode.Domain.LLM.Anthropic do
  @moduledoc """
  ...
  the body (spec 45 §3.4, `SwarmCode.Domain.LLM.Efforts.apply/2`).
  ...
  def put_thinking(body, %Request{} = r),
    do: body |> SwarmCode.Domain.LLM.Efforts.apply(r) |> sanitise_thinking(r.model)
