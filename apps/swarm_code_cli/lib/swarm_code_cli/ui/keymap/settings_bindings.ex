defmodule SwarmCodeCLI.UI.Keymap.SettingsBindings do
  ...
  @rows [
    ...
    {:settings_left, [{:left, []}], :left,
     ...
     "Back to the rail or step down (an enum or a number on its row; in text the caret left)", 0,
     true},
    {:settings_right, [{:right, []}], :right,
     [:settings, :settings_edit, :settings_search, :settings_popover], "Right",
     "Open the section or step up (an enum or a number on its row; in text the caret right)", 0,
     true},
