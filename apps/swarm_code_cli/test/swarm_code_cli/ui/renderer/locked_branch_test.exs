defmodule SwarmCodeCLI.UI.Renderer.LockedBranchTest do
  ...
  test "locked branch retains only neutral dependencies and no conditional campaign outputs" do
    ...
    # pass70 B7: `umask 077` and `RELEASE_DISTRIBUTION=none`; F13: `+Bd`;
    # pass71 F6: `SWARM_USER_UMASK` keeps the user's umask for project commands.
    assert audit.rel_env_sha256 ==
             "efa7c49354cce08e435f6ae21e51a9bd02214e4649558761dba5cc01255a76c9"
