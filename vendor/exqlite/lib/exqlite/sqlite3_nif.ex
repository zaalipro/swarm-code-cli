defmodule Exqlite.Sqlite3NIF do
  ...
  if @swarm_guard_test do
    ...
    def guard_connection_identity(_arg), do: :erlang.nif_error(:not_loaded)
    def guard_resource_close(_arg), do: :erlang.nif_error(:not_loaded)
    def guard_close_attested(_arg), do: :erlang.nif_error(:not_loaded)
